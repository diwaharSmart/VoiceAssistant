...
#     cart_model = models.ForeignKey(LLMModel, on_delete=models.CASCADE, blank=True, null=True, related_name="settings_cart_model")
#     prompt = models.TextField(blank=True,null=True)
#     cart_prompt = models.TextField(blank=True,null=True)
